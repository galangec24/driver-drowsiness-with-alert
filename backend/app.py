        ...
        with get_db_connection() as conn:
            ...
            if new_phone:
                ...
                if cursor.fetchone():
                    return jsonify({
                        'success': False,
                        'error': f'Phone number {phone_clean} is already registered for another driver'
                    }), 409
            ...
            cursor.execute(query, (*update_values, datetime.now()))
            conn.commit()
